                ...
                <div className="projects_gallery container">
                    <div className="gallery">
                        ...
                        <div className="gallery_desc">
                            <p className="gallery_para">Metabolic Bacterial Tracking is an interface for optimization of calculating
                            ...
                            <p className="gallery_para">Respiratory activity is the interface for calculating respiratory activity of the soil with Excel tables.
                                ...
                                <br /><a href="https://github.com/projacktor/Soil_respiratory_activity_GUI" target="_blank">GitHub repo</a>
                            </p>
                            <p className="gallery_para">RBD is the bot that was made for helping high school students in essay writing.
                                The bot has an interface for relating with a Google Sheet where students can find lots of information about school program books.
                                <br /><span className="gallery_desc_stack">Stack:</span> Python + GoogleAPI + Telegram
                                <br /><a href="https://github.com/projacktor/telegram_RDB_bot" target="_blank">GitHub repo</a>
                            </p>
                            <p className="gallery_para">The project provides a bot as interface for downloading audio tracks from YouTube videos
                                <br /><span className="gallery_desc_stack">Stack:</span> Python + Telegram + YouTubeAPI
                                <br /><a href="https://github.com/projacktor/Telegram_Audio-Video_bot" target="_blank">GitHub repo</a>
                            </p>
                        </div>
                    </div>
                    <div className="gallery_scroller">
                        ...
                        <div className="gallery_pointer">
                            <svg className="scroller" width="110" height="10" viewBox="0 0 110 10" fill="none" xmlns="http://www.w3.org/2000/svg">
